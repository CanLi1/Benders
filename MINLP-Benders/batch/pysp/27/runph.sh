...
-k --verbose  --scenario-solver-options="MaxTime=600" --output-solver-logs  --default-rho=1 \
 --ww-extension-cfgfile=config/wwph.cfg \
 --ww-extension-suffixfile=config/wwph.suffixes --linearize-nonbinary-penalty-terms=7 > serial-baron.log
