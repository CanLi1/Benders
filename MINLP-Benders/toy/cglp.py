...
cg.ncolumn = Param(default=0, mutable=True)
cg.nnodes = Param(default=0, mutable=True)
cg.nrow = Param(default=0, mutable=True)
cg.nrow1 = Param(default=0, mutable=True)
