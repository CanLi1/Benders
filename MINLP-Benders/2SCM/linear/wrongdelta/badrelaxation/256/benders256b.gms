...
*solve upper bound each subproblem
  ...
  Repeat
    loop(w3$handlecollect(Bendersub_handle(w3)),
        ...
        abort$((bendersub.modelStat ne 1 and bendersub.modelStat ne 2 and bendersub.modelStat ne 1)  or bendersub.solveStat ne 1) 'abort due to errors solve upper bound sub';
...
*add benders cuts, solve each benders subproblem--------------
  ...
  Repeat
    loop(w3$handlecollect(Bendersub_handle(w3)),
      ...
      abort$(bendersub.modelStat ne 1 or bendersub.solveStat ne 1) 'abort due to errors solve Bender subproblem';
      display$handledelete(Bendersub_handle(w3)) 'trouble deleting handles';
      Bendersub_handle(w3)=0;
      );
