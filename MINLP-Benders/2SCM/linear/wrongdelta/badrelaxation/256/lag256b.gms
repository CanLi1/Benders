...
model bendersmaster /bobj, b1,b2, b4/;
...
display x_record_lag,Q_record_lag,mux, muQ, obj_record, pix_all, piQ_all,xf_record, Qf_record;

display lag_sub_modelstat,bender_sub_modelstat,upper_sub_modelstat,master_modelstat,total_obj_record, BenderOBJ_record, UB_Bender,UB, LB, WallTime,cpu_ub, cpu_bender_sub, cpu_bender_master,cpu_lag ;
