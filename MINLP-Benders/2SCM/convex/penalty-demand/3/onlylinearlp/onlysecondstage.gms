...
equations
lp1, lp2;
lp1(iiter,rr,pp,w)$(freeze(w) and aRP(iiter,rr,pp,w)) .. sum((r,p,j)$RJ(r,j), PUrp(iiter,r,p,j,w,rr,pp)*PU(r,p,j,w) ) + sum((p,c,j), Frp(iiter,p,c,j,w,rr,pp)*F(p,c,j,w)) + sum((p,i,j,s)$(JM(i,s,j) and PS(i,s)and (ord(i) ne 4 or ord(j) ne 5 )), thetarp(iiter,p,i,j,s,w,rr,pp)*theta(p,i,j,s,w) ) + sum((p,i,j,s)$(JM(i,s,j) and PS(i,s)and (ord(i) eq 4 and ord(j) eq 5 )), thetarp(iiter,p,i,j,s,w,rr,pp)*theta(p,i,j,s,w) )+ sum((p,i,j,s)$((L(i,s,j) or Lbar(i,s,j)) and PS(i,s)), WWrp(iiter,p,i,j,s,w,rr,pp)*WW(p,i,j,s,w)) + sum((c,j)$(ord(j)=3 or ord(j)=5), Slackrp(iiter,c,j,w,rr,pp)*Slack(c,j,w) ) + sum((r,p), yrp(iiter,r,p,w,rr,pp)*y(r,p,w)) +sum((p,c), zrp(iiter,p,c,w,rr,pp)*z(p,c,w)) + drpconst(iiter,w,rr,pp)=l= 0;
lp2(iiter,pp,cc,w)$(freeze(w) and aPC(iiter,pp,cc,w)) .. sum((r,p,j)$RJ(r,j), PUpc(iiter,r,p,j,w,pp,cc)*PU(r,p,j,w) ) + sum((p,c,j), Fpc(iiter,p,c,j,w,pp,cc)*F(p,c,j,w)) + sum((p,i,j,s)$(JM(i,s,j) and PS(i,s)and (ord(i) ne 4 or ord(j) ne 5 )), thetapc(iiter,p,i,j,s,w,pp,cc)*theta(p,i,j,s,w) ) + sum((p,i,j,s)$(JM(i,s,j) and PS(i,s)and (ord(i) eq 4 and ord(j) eq 5 )), thetapc(iiter,p,i,j,s,w,pp,cc)*theta(p,i,j,s,w) )+ sum((p,i,j,s)$((L(i,s,j) or Lbar(i,s,j)) and PS(i,s)), WWpc(iiter,p,i,j,s,w,pp,cc)*WW(p,i,j,s,w)) + sum((c,j)$(ord(j)=3 or ord(j)=5), Slackpc(iiter,c,j,w,pp,cc)*Slack(c,j,w) ) + sum((r,p), ypc(iiter,r,p,w,pp,cc)*y(r,p,w)) +sum((p,c), zpc(iiter,p,c,w,pp,cc)*z(p,c,w)) +dpcconst(iiter,w,pp,cc) =l= 0;
...
equations
d1, d2,d3,d5,d6,d7,d8,d9,d10,d11,d12,d14,d12p,d14p,d15,d16,d17,de1,de3,de5,de6,de7,de8,de9,de10,de11,de12,delp1,delp2,ds1,ds2,ds3,ds4,dobj;
...
model sep /d1, d2,d3,d5,d6,d7,d8,d9,d10,d11,d12,d14,d12p,d14p,d15,d16,d17,de1,de3,de5,de6,de7,de8,de9,de10,de11,de12,ds1,ds2,ds3,ds4,n1p,n1m,n2p,n2m,n3p,n3m,n4p,n4m,n5p,n5m,n6p,n6m,n7p,n7m,n8p,n8m/;
