...
b3( iiiter)$biter(iiiter)  .. BenderOBJ =g=sum(w, v(iiiter, w) + sum((p,i), g1(iiiter, p,i,w) * xf(p,i) + g2(iiiter, p,i, w) * Qf(p,i) ) );
...
model sep /f1,f2,f3,f4,d1, d2,d3,d5,d6,d7,d8,d9,d10,d11,d12,d14,d12p,d14p,d15,d16,d17,de1,de3,de4,de5,de6,de7,de8,de9,de10,de11,de12,delp1,delp2,ds1,ds2,ds3,ds4,n1p,n1m,n2p,n2m,n3p,n3m,n4p,n4m,n5p,n5m,n6p,n6m,n7p,n7m,n8p,n8m,n9p, n9m, n10p, n10m/;
