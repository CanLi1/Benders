...
equations
f1,f2,f3,f4,d1, d2,d3,d5,d6,d7,d8,d9,d10,d11,d12,d14,d12p,d14p,d15,d16,d17,de1,de3,de4,de5,de6,de7,de8,de9,de10,de11,de12,ds1,ds2,ds3,ds4,dobj;
...
model sep /f1,f2,f3,f4,d1, d2,d3,d5,d6,d7,d8,d9,d10,d11,d12,d14,d12p,d14p,d15,d16,d17,de1,de3,de4,de5,de6,de7,de8,de9,de10,de11,de12,ds1,ds2,ds3,ds4,dobj,n1p,n1m,n2p,n2m,n3p,n3m,n4p,n4m,n5p,n5m,n6p,n6m,n7p,n7m,n8p,n8m,n9p, n9m, n10p, n10m/;
...
*update parameters
  xrp(iter, p,i, w3, r3, p3) = -f2.m(p,i);
  QErp(iter,p,i,w3, r3,p3) = -f1.m(p,i);
          PUrp(iter,r,p,j,w3,r3,p3) = -d1.m(r,p,j,w3);
        Frp(iter,p,c,j,w3,r3,p3) = -d2.m(p,c,j,w3);
        thetarp(iter,p,i,j,s,w3,r3,p3) = -d3.m(p,i,j,s,w3);
        WWrp(iter,p,i,j,s,w3,r3,p3) = -d5.m(p,i,j,s,w3);
        Slackrp(iter,c,j,w3,r3,p3) = -d6.m(c,j,w3);
        yrp(iter,r,p,w3,r3,p3) = -d7.m(r,p,w3);
        zrp(iter,p,c,w3,r3,p3) = -d8.m(p,c, w3);
        drpconst(iter,w3,r3,p3) = d9.m;
...
*       abort$(sep.modelStat ne 2 and sep.modelStat ne 1 and sep.modelStat ne 7) "abort due to errors solving sep problem";
       display$handledelete(sep_handle(w3)) 'trouble deleting handles';
        if(dnorm.l lt 1e-1 or (sep.modelStat ne 2 and sep.modelStat ne 1),
  ...
  loop(c3,
    ...
    Repeat
      loop(w3$handlecollect(sep_handle(w3)),
        cpu_sep = cpu_sep + sep.resusd;
*update parameters
        xpc(iter, p,i,w3, p3,c3) = -f2.m(p,i);
        QEpc(iter, p,i,w3, p3,c3) = -f1.m(p,i);
          PUpc(iter,r,p,j,w3,p3,c3) = -d1.m(r,p,j,w3);
        Fpc(iter,p,c,j,w3,p3,c3) = -d2.m(p,c,j,w3);
        thetapc(iter,p,i,j,s,w3,p3,c3) = -d3.m(p,i,j,s,w3);
        WWpc(iter,p,i,j,s,w3,p3,c3) = -d5.m(p,i,j,s,w3);
        Slackpc(iter,c,j,w3,p3,c3) = -d6.m(c,j,w3);
        ypc(iter,r,p,w3,p3,c3) = -d7.m(r,p,w3);
        zpc(iter,p,c,w3,p3,c3) = -d8.m(p,c, w3);
        dpcconst(iter,w3,p3,c3) = d9.m;
        display sep.modelStat;
        if(dnorm.l lt 1e-1 or (sep.modelStat ne 2 and sep.modelStat ne 1),
