...
LB 
UB
LB_record(lstep, ltheta)
UB_record(lstep, ltheta)
temp1
temp2;
...
if(ord(iter) lt 30, 
  ...
  if(LB * 1.01 gt UB,
    LB_record(lstep, ltheta) = LB;
    UB_record(lstep, ltheta) = UB;
    temp1 = theta00(ltheta);
    temp2 = half00(lstep);
    display UB, LB, temp1, temp2;
  break; );
