     ...
     loop(sub5,
      loop(sub6,
        loop(sub7,
            ...
            num = 1*(2-ord(sub0))+2*(2-ord(sub1))+4*(2-ord(sub2))+8*(2-ord(sub3))+16*(2-ord(sub4))+32*(2-ord(sub5))+64*(2-ord(sub6))+128*(2-ord(sub7));
            loop(w, 
              if(ord(w) eq num + 1,
...
prob(w) = baseprob(sub0) *baseprob(sub1) *baseprob(sub2) *baseprob(sub3) *baseprob(sub4) *baseprob(sub5) *baseprob(sub6) *baseprob(sub7); 
