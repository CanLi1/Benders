...
-np 1 pyomo_ns : \
-np 1 dispatch_srvr : \
-np 12 phsolverserver : \
-np 1  runph --model-directory=models --instance-directory=nodedata/256 \
--traceback --enable-ww-extensions --max-iterations=5\
 ...
 --ww-extension-suffixfile=config/wwph.suffixes --linearize-nonbinary-penalty-terms=7 >output256timelim.log