...
double00(ld) / ld1 1.2, ld2 1.4, ld3 1.6, ld4 1.8, ld5 2/
mintheta00(mt) /mt1 1e-3, mt2 1e-4, mt3 1e-5/
*half00(lstep) / half1 0.5, half2 0.6/
*double00(ld) / ld1 1.2, ld2 1.4/
*mintheta00(mt) /mt1 1e-3, mt2 1e-4/
mintheta0
half0 
change;
mux('1',p,i,w) = 0;
...
display LB_record, UB_record,  total_obj_record, theta_record;
